...
if __package__ is None:
    ...
    from .clients.throughput import ThroughputClient  # type: ignore
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--connect_timeout_s", type=float, default=20.0, help="Seconds to wait for a BLE connection before failing an attempt.")
    parser.add_argument(
        "--connect_attempts",
        type=int,
        default=3,
